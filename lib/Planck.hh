...
inline fp_t
pwr_law_reject(fp_t const alpha, fp_t const e_a, fp_t const x)
{
...
inline fp_t
gen_power_law_energy(fp_t const alpha, fp_t const ebar, rng_t & rng)
{
  fp_t energy = 0.0;
...
template <typename fp_t>
inline fp_t
pwr_law_reject_alpha2(fp_t const x)
{
...
template <typename rng_t, typename fp_t>
inline fp_t
gen_power_law_energy_alpha2(fp_t const ebar, rng_t & rng)
{
  fp_t energy = 0.0;
