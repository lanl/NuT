...
bool vec_soft_equiv(vector_t const &v, vector_t const &v_exp,
                    std::string const &s, double tol = 5e-14) {
  bool passed(true);
...
template <size_t S, typename geom_t = double> struct Buffer_RNG {
