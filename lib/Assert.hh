...
namespace dbc
{
    ...
    static inline
    void resize_vec(vec_t & v, size_t const s, char const * const fname,
                    char const * const elemName)
    {
        ...
        catch(std::exception & exc)
        {
            ...
            errstr << fname << ": failed to allocate memory for "
                   << s << " " << elemName << "s.\n";
            throw exc;
        }
    }
    ...
    static inline
    void Insist( bool const cond, char const * const msg)
    {
        if(!cond)
        {
    ...
    static inline
    void Check(bool const cond, char const * const msg)
    {
        if(!cond)
        {
            throw std::runtime_error(msg);
    ...
    inline
    void Equal(eq_t const & a, eq_t const & b, char const * const a_name_cstr,
    ...
    inline
    void InOpenRange(comp_t const & x, comp_t const & min, comp_t const & max,
...
#define LessThan     LessThan_off
    ...
    static inline
    void Require(bool const , char const * const ){}
    ...
    template <typename gt_t>
    inline
    void LessThan(gt_t const &, gt_t const &, char const * const){}

    template <typename gt_t>
    inline
    void LessThan(gt_t const &, gt_t const &, char const * const, char const * const){}

    template <typename gt_t>
    void GreaterEqual(gt_t const & , gt_t const &, char const * const ){}
