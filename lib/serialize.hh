...
void
summarize_stats(stats_t const & stats,
                std::ostream & o,
                Species const s,
                uint32_t const cycle_no)
{
  ...
  o << "For species " << sname << ":\n"
    << std::setprecision(15) << "\t" << n_p << " particles\n"
...
void
summarize_tally(Tally_T const & tally,
                std::ostream & o,
                Species const s,
                uint32_t const cycle_no)
{
  ...
  switch(s) {
    ...
    case nu_x:
      ...
      break;
    default:
      std::cerr << "summarize_tally: unhandled species " << sname << std::endl;
  }
  o << "==================================================\n"
    << "Results for cycle " << cycle_no << ", " << sname << ":\n"
    << std::setprecision(15) << "Total energy deposited: " << e_tot << "\n"
...
template <typename Tally_T>
void
write_deposition(std::ostream & o, Tally_T const & tally)
{
  // header
...
template <typename Tally_T>
void
write_tally_mcphd(std::ostream & o,
                  Tally_T & tally,
                  Species const s,
                  uint32_t const cycle_no)
{
            ...
            uint32_t const cycle_no)
{
  ...
  print_per_cell_field<fp_t, fpItT>("energy", tally.energy.begin(),
                                    tally.energy.end(), o);
  print_per_cell_field<fp_t, fpItT>("momentum", tally.momentum.begin(),
                                    tally.momentum.end(), o);

  // number and weight created in other fields
  print_per_cell_field<cntr_t, cItT>("n_n", tally.n_n.begin(), tally.n_n.end(),
                                     o);
  print_per_cell_field<cntr_t, cItT>("n_p", tally.n_p.begin(), tally.n_p.end(),
                                     o);
  print_per_cell_field<cntr_t, cItT>("n_e_minus", tally.n_e_minus.begin(),
                                     tally.n_e_minus.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_e_plus", tally.n_e_plus.begin(),
                                     tally.n_e_plus.end(), o);

  print_per_cell_field<fp_t, fpItT>("ew_n", tally.ew_n.begin(),
                                    tally.ew_n.end(), o);
  print_per_cell_field<fp_t, fpItT>("ew_p", tally.ew_p.begin(),
                                    tally.ew_p.end(), o);
  print_per_cell_field<fp_t, fpItT>("ew_e_minus", tally.ew_e_minus.begin(),
                                    tally.ew_e_minus.end(), o);
  print_per_cell_field<fp_t, fpItT>("ew_e_plus", tally.ew_e_plus.begin(),
                                    tally.ew_e_plus.end(), o);

  // event counters
  print_per_cell_field<cntr_t, cItT>("n_escape", tally.n_escape.begin(),
                                     tally.n_escape.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_reflect", tally.n_reflect.begin(),
                                     tally.n_reflect.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_cell_bdy", tally.n_cell_bdy.begin(),
                                     tally.n_cell_bdy.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_cutoff", tally.n_cutoff.begin(),
                                     tally.n_cutoff.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_nucl_el_scat",
                                     tally.n_nucl_el_scat.begin(),
                                     tally.n_nucl_el_scat.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_nu_e_el_scat",
                                     tally.n_nu_e_el_scat.begin(),
                                     tally.n_nu_e_el_scat.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_nu_e_bar_pos_scat",
                                     tally.n_nu_e_bar_pos_scat.begin(),
                                     tally.n_nu_e_bar_pos_scat.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_nu_x_el_scat",
                                     tally.n_nu_x_el_scat.begin(),
                                     tally.n_nu_x_el_scat.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_nu_x_bar_pos_scat",
                                     tally.n_nu_x_bar_pos_scat.begin(),
                                     tally.n_nu_x_bar_pos_scat.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_nu_e_nucl_abs",
                                     tally.n_nu_e_nucl_abs.begin(),
                                     tally.n_nu_e_nucl_abs.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_nu_e_bar_nucl_abs",
                                     tally.n_nu_e_bar_nucl_abs.begin(),
                                     tally.n_nu_e_bar_nucl_abs.end(), o);

  // some associated energy weights (???)
  print_per_cell_field<fp_t, fpItT>("ew_nu_e_nucl_abs",
                                    tally.ew_nu_e_nucl_abs.begin(),
                                    tally.ew_nu_e_nucl_abs.end(), o);
  print_per_cell_field<fp_t, fpItT>("ew_nu_e_bar_nucl_abs",
                                    tally.ew_nu_e_bar_nucl_abs.begin(),
                                    tally.ew_nu_e_bar_nucl_abs.end(), o);

  // census counts & weights
  print_per_cell_field<cntr_t, cItT>("n_census_nu_e",
                                     tally.n_census_nu_e.begin(),
                                     tally.n_census_nu_e.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_census_nu_e_bar",
                                     tally.n_census_nu_e_bar.begin(),
                                     tally.n_census_nu_e_bar.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_census_nu_x",
                                     tally.n_census_nu_x.begin(),
                                     tally.n_census_nu_x.end(), o);
  print_per_cell_field<cntr_t, cItT>("n_census_nu_x_bar",
                                     tally.n_census_nu_x_bar.begin(),
                                     tally.n_census_nu_x_bar.end(), o);

  print_per_cell_field<fp_t, fpItT>("ew_census_nu_e",
                                    tally.ew_census_nu_e.begin(),
                                    tally.ew_census_nu_e.end(), o);
  print_per_cell_field<fp_t, fpItT>("ew_census_nu_e_bar",
                                    tally.ew_census_nu_e_bar.begin(),
                                    tally.ew_census_nu_e_bar.end(), o);
  print_per_cell_field<fp_t, fpItT>("ew_census_nu_x",
                                    tally.ew_census_nu_x.begin(),
                                    tally.ew_census_nu_x.end(), o);
  print_per_cell_field<fp_t, fpItT>("ew_census_nu_x_bar",
                                    tally.ew_census_nu_x_bar.begin(),
                                    tally.ew_census_nu_x_bar.end(), o);

  // escape spectrum
  print_esc_spectrum<typename Tally_T::esc, typename Tally_T::vesc::iterator>(
...
void
advance_to_string(std::istream & i, const char * s)
{
  ...
  while(advance) {
    ...
    sline.assign(line);
    if(sline.find(s) != std::string::npos) { advance = false; }
  }
  return;
}
