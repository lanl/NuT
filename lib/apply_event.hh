...
namespace nut
{
        ...
        )
    {
        ...
        case nucleon_elastic_scatter:
            apply_nucleon_elastic_scatter<ParticleT,Tally<fp_t>,VelocityT,fp_t>(
                p,tally,velocity);
            break;
        case electron_scatter:
            {
                ...
                apply_lepton_scatter(p,tally,e_e,velocity);
            }
            break;
                                       ...
                                       vel_t const & vel)
    {
        ...
        // scatter
        fp_t const seed  = p.rng.random();
        geom_t const ocf = 2 * seed - 1;
        // LT comoving -> lab
        EandOmega const eno_lf = LT_to_lab_sphere1D(v,eci,ocf);
        geom_t const elf = eno_lf.first;
        geom_t const olf = eno_lf.second;
        // tally
    ...
    template <typename p_t, typename tally_t,
              typename velocity_t, typename fp_t>
                              ...
                              velocity_t const & vel)
    {
        ...
        geom_t const eci  = eno_cmi.first;
        // scatter
        fp_t seed = p.rng.random();
        fp_t ocf = 2 * seed - 1;
        fp_t const de = (eci - e_lep)/4.;
        fp_t const ecf = eci - de;
        // LT comoving -> lab
        EandOmega const eno_lf = LT_to_lab_sphere1D(v,ecf,ocf);
        geom_t const elf = eno_lf.first;
        geom_t const olf = eno_lf.second;
        // tally
